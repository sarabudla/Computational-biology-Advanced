...
# Usage
###
# Copy sbatch_clustalAlign.sh and clustalAlign.sh to your /scratch/sarabudla.n/ directory (or subdirectory)
# From that same directory run this command: 
# sbatch sbatch_clustalAlign.sh /home/sarabudla.n/BINF6309/module06-nithyasarabudla
#
# ASSUMES that input apoe_aa.fasta is also in the /home/sarabudla.n/BINF6309/module06-nithyasarabudla
